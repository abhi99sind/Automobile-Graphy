...
$q="select * from showroom where category_name='bikes'";
$qry=$connect->query($q);
?>
<!doctype html>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 ">
                    <ul class="right-none pull-right company_info">
                        <li><a href="tel:8800733833"><i class="fa fa-phone"></i>+91-8800733833</a></li>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav pull-right">
                            <li><a href="index.php">Home</a></li>
                             <li class="active dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Showroom<b class="caret"></b></a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
                <h2>OUR SHOWROOM</h2>
                <h4>Varient Bikes,Varient Vehicle Type</h4>
            </div>
        ...
        <div class="inner-page row">
            ...
            <div class="content-wrap car_listings">
                <div class="row">
                        ...
                        <?php echo "<img src='admin-pannel/img/$r[27]'class='preview' alt='preview'>";?>
                        ...
                        <table class="options-secondary">
                            ...
                            <div class="figure"><?php echo $r[26]; ?><br>
                            </div>
...
<section class="copyright-wrap padding-bottom-10">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-2 col-xs-12">
                <ul class="social margin-bottom-5 md-margin-bottom-5 sm-margin-bottom-6 xs-margin-bottom-6 xs-padding-top-6 clearfix">
                     <a href="https://m.facebook.com/automobilegraphy" class="fa fa-facebook"></a>
                 <a href="https://www.youtube.com/channel/UCmAs4RMvzXZWY6Z4-WyK50Q" class="fa fa-youtube" style="height=10px width=10px"></a>
                 <a href="https://www.instagram.com/automobile_graphy" class="fa fa-instagram"></a>
