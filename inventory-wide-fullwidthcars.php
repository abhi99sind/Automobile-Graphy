...
$q="select * from showroom where category_name='cars'";
$qry=$connect->query($q);
?>
<!doctype html>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 ">
                    <ul class="right-none pull-right company_info">
                        <li><a href="tel:88007333833"><i class="fa fa-phone"></i>+91-88007333833</a></li>
        ...
        <div class="inner-page row">
            ...
            <div class="content-wrap car_listings">
                <div class="row">
                        ...
                        <div class="view-video gradient_button" data-youtube-id="<?php echo $r[25]; ?>"><i class="fa fa-video-camera"></i> View Video</div>
                    </div>
					<?php 
							}
					?>
